document.addEventListener('DOMContentLoaded', function() {
    ...
    header.innerHTML = `
        <div class="navbar" id="navbar">
            ...
            <nav>
                <ul>
                    <li><a href="/Portfolio/University_Projects" data-i18n="navbar-portfolio-university-projects"></a></li>
                    <li><a href="#" data-i18n="navbar-portfolio-personal-projects"></a></li>
                </ul>
            </nav>
        </div>
    `;
